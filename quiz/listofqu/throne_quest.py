...
class ThroneQuest(quiz_model.Qa):
...
def play_throne_quest():
    ThroneQuest.display_art()
    file = quiz_model.Qa.open_file(FilePath.file__path('thronequest'))
    line = '<>======================================================<>'
    ...
    list_of_qa = [
        ...
        quiz_model.Qa(f'{file[7][0]}\n{line}\n(1) ' f'{file[7][1]}\n(2) {file[7][2]}\n(3) {file[7][3]}\n(4) {file[7][4]}\n', '1'),

        quiz_model.Qa(f'{file[8][0]}\n{line}\n(1) ' f'{file[8][1]}\n(2) {file[8][2]}\n(3) {file[8][3]}\n(4) {file[8][4]}\n', '4'),
