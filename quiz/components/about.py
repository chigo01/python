...
def about_game():  # Displays the about page, the instructions, and the details of the Quiz Categories.
    ...
    print(
        "There are 4 Categories to choose from, each consists of 20 questions and randomly drawn from a question pool.")
    print()
    ...
    print("Each question in this category amounts to 2 points.")
    print("---------------------------------------------------------------------- ")
    print("For suggestions and inquiries you may email me at baruchfavour01@gmail.com")
    print()
    menu.menu_game()
